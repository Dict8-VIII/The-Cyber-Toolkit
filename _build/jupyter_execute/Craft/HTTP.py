...
# 
# While web browsers are commonly used for retrieving pages, this isnt a requirement. A telnet client could also request these (or curl). HTTP servers are normally hosted on port 80, but dont have to be.
# 
# ## HTTP Methods (Verb)
...
# 
# If this all goes well, you will recieve the page code to your terminal. Simple.
# 
# <hr>
