...
# ### Man In The Middle
# 
# A "Man in the Middle" attack is when data is intercepted in transit and relayed on. A good analogy would be using the mail system to send cash (there’s a reason they tell you not to do this). You might want to send a birthday letter to a niece/nephew on the other side of the country and throw in some birthday money. You drop it at the post office with $50 inside but someone heard there was cash inside. After you send the letter, the postman opens your letter, takes out the $50 and replaces it with $5, then sends the letter on its way. The letter still reaches the destination but has been modified. Unless someone verifies the amount, no-one is going to know 90% of the value was lost. <br>
# 
